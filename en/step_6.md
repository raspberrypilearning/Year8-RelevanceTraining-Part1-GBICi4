## Data collection using the online surveys
...
You will need to assign time in Session 1 to complete the pre-survey, and at the end of the final session (Session 13) to complete the post-survey.
